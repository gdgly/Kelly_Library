...
****************************************************************************//*!
*
* @brief  FreeMASTER Driver main API header file, MPC55xx platform
*
...
#define FMSTR_PLATFORM_MPC55xx 1
...
void FMSTR_Isr(unsigned long vec);      /* SCI or FlexCAN interrupt handler for LONG_INTR and SHORT_INTR modes */
