...
/*********************************************************************************
* communication buffer access functions. Most of them are trivial simple on MPC55xx
*********************************************************************************/
...
/* FlexCAN functionality implumented on MPC55xx */
...
#define FMSTR_SETBIT16(base, offset, bit)       ((*(volatile FMSTR_U32*)(((FMSTR_U32)(base))+(offset))) |= bit)
#define FMSTR_CLRBIT16(base, offset, bit)       ((*(volatile FMSTR_U32*)(((FMSTR_U32)(base))+(offset))) &= ~(bit))
...
#define FMSTR_SCI_TE_RE() FMSTR_SETBIT32(FMSTR_SCI_BASE, FMSTR_SCICR1_OFFSET, FMSTR_SCICR1_RE | FMSTR_SCICR1_TE)
...
#define FMSTR_SCI_RDCLRSR() FMSTR_SETREG32(FMSTR_SCI_BASE, FMSTR_SCISR_OFFSET, FMSTR_GETREG32(FMSTR_SCI_BASE, FMSTR_SCISR_OFFSET))
